...
export function RequisitionStatusBadge({ status }: RequisitionStatusBadgeProps) {
  const statusConfig: Record<string, { label: string; className: string }> = {
    ...
    COMPLETED: { label: 'Completed', className: 'bg-green-100 text-green-700 ring-green-600/20' },
    CLOSED: { label: 'Closed', className: 'bg-gray-100 text-gray-700 ring-gray-600/20' },
  };
