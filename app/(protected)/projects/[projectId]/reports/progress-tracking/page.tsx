// app/(protected)/projects/[projectId]/reports/progress-tracking/page.tsx
    ...
    return (
      <div className="p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">Progress Tracking Report</h1>
    ...
    <div className="p-6 space-y-8 max-w-[1600px] mx-auto bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-200 pb-6">
        ...
        <div className="flex flex-wrap gap-2">
          <Link
            href={`/projects/${projectId}/reports`}
            className="inline-flex items-center gap-2 rounded-lg border border-transparent bg-white border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 transition-colors"
          >
      ...
      {/* Report Title for Print/View */}
      <div className="mb-4">
        <h2 className="text-2xl font-bold text-gray-900">Progress Tracking Report</h2>
      </div>
