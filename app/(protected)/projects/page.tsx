                            ...
                            <div className="flex items-center justify-center gap-2">
                              {isProjectManager && currentTab === 'unplanned' ? (
                                <Link 
                                   ...
                                   className="inline-flex items-center gap-1 rounded border border-orange-600 bg-orange-600 px-3 py-1.5 text-xs font-bold text-white transition-colors hover:bg-orange-700 shadow-sm"
                                >
