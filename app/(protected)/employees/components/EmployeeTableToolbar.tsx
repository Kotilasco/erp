  ...
  return (
    <div className="flex flex-wrap items-center gap-3 rounded-lg bg-blue-50 p-2 dark:bg-gray-800 border border-blue-100 dark:border-gray-700 mb-4">
      <div className="flex items-center gap-2">
         <span className="bg-indigo-600 text-white px-2 py-1 rounded text-xs font-bold shadow-sm">Show</span>
         <select
            value={pageSize}
            onChange={(e) => {
            ...
            className="rounded border-gray-300 py-1 text-sm focus:border-indigo-600 focus:ring-indigo-600 dark:bg-gray-700 dark:border-gray-600 shadow-sm"
         >
      ...
      <div className="flex items-center gap-2">
         <span className="bg-indigo-600 text-white px-2 py-1 rounded text-xs font-bold shadow-sm">Status</span>
         <select
            value={status}
            onChange={(e) => setStatus(e.target.value)}
            className="rounded border-gray-300 py-1 text-sm focus:border-indigo-600 focus:ring-indigo-600 dark:bg-gray-700 dark:border-gray-600 min-w-[150px] shadow-sm"
         >
